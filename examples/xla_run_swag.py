        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    # optimizer.step()
                    # print(torch_xla._XLAC._get_xla_tensors_dot(list(model.parameters())))
                    xm.optimizer_step(optimizer)
                    logger.info("DONE 1 optimizer step")
                    logger.info(torch_xla._XLAC._xla_metrics_report())
                    optimizer.zero_grad()
                    global_step += 1
